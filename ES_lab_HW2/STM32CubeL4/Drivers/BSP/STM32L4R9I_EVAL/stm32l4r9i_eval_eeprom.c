  ...
  @verbatim
            ...
            Notes:
             - The I2C EEPROM memory (M24LR64) is available on separate daughter
               board ANT7-M24LR-A, which is not provided with the STM32L4R9I_EVAL
               board.
               To use this driver you have to connect the ANT7-M24LR-A to CN5
               connector of STM32L4R9I_EVAL board.
            ===================================================================

            It implements a high level communication layer for read and write
            from/to this memory. The needed STM32L4xx hardware resources (I2C and
            GPIO) are defined in stm32l4r9i_eval.h file, and the initialization is
            performed in EEPROM_IO_Init() function declared in stm32l4r9i_eval.c
            file.
...
/** @defgroup STM32L4R9I_EVAL_EEPROM STM32L4R9I_EVAL EEPROM
  * @brief This file includes the I2C EEPROM driver of STM32L4R9I-EVAL evaluation board.
  * @{
  */

/** @defgroup STM32L4R9I_EVAL_EEPROM_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32L4R9I_EVAL_EEPROM_Exported_Functions Exported Functions
  * @{
  */
