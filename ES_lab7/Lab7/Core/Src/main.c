...
uint32_t TaskFilterBuffer[ 512 ];
osStaticThreadDef_t TaskFilterControlBlock;
const osThreadAttr_t TaskFilter_attributes = {
  .name = "TaskFilter",
  .cb_mem = &TaskFilterControlBlock,
  .cb_size = sizeof(TaskFilterControlBlock),
  .stack_mem = &TaskFilterBuffer[0],
  .stack_size = sizeof(TaskFilterBuffer),
  .priority = (osPriority_t) osPriorityHigh5,
};
/* Definitions for TaskVis */
osThreadId_t TaskVisHandle;
uint32_t TaskVisBuffer[ 512 ];
osStaticThreadDef_t TaskVisControlBlock;
const osThreadAttr_t TaskVis_attributes = {
  .name = "TaskVis",
  .cb_mem = &TaskVisControlBlock,
...
/* USER CODE BEGIN Header_StartTaskFilter */
/**
* @brief Function implementing the TaskFilter thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_StartTaskVis */
/**
* @brief Function implementing the TaskVis thread.
* @param argument: Not used
* @retval None
*/
