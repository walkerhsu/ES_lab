...
import 'package:tsmc/BLE/selected_device.dart';
                                ...
                                onPressed: () {
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) =>
                                      ConnectingModal(device: templist[index].device),
                                  );
                                },
                                child: 
                                // check the redux state to know whether the device is connected
                                StoreProvider.of<AppState>(context).state.connectedDevice == templist[index].device ?
